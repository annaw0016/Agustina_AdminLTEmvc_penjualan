...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-6" style="color: #333333;">
        <h1 style="color: #ff6347;">Daftar Pelanggan</h1>
    </div>
    </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body">
    <a href="index.php?controller=pelanggan&action=create" class="btn btn-success btn-lg mb-3">Tambah Data</a>
        ...
        <tbody>
            <?php foreach ($data as $key => $pelanggan): ?>
                <tr>
                    ...
                    <td>
                        <a href="index.php?controller=pelanggan&action=edit&id=<?= $pelanggan['id_pelanggan'] ?>" class="btn btn-sm btn-info btn-lg">Edit</a>
                        <a href="index.php?controller=pelanggan&action=delete&id=<?= $pelanggan['id_pelanggan'] ?>" class="btn btn-sm btn-danger btn-lg" 
