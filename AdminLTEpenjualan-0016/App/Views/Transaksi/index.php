...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-6" style="color: #333333;">
        <h1 style="color: #ff6347;">Daftar Transaksi</h1>
    </div>
    </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-body">
        <a href="index.php?controller=transaksi&action=create" class="btn btn-success btn-lg mb-3">Tambah Data</a>
    ...
    <tbody>
        <?php foreach ($transaksiList as $key => $transaksi): ?>
            <tr>
                ...
                <td>
                    <a href="index.php?controller=transaksi&action=detail&id=<?= $transaksi['id'] ?>" class="btn btn-sm btn-warning btn-lg">Detail</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
